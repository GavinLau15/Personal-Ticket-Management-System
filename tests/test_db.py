import pytest
import psycopg2
from source.database import create_ticket
...
def test_create_ticket(cursor):
    ...
    # ticket1 = create_ticket(cur, "Outlook Setup", "Low", "In Progress", "Set up Outlook account")
    # ticket2 = create_ticket(cur, "Desktop Crashing", "Medium", "Assigned", "Desktop is frequently crashing")
    ...
    # ticket7 = create_ticket(cur, "Printer jamming", "Low", "Resolved", "Printer is jamming when printing lare loads")